                        ...
                        const pcl::PointCloud<pcl::PointXYZI> &query_voi)
{
    ...
    //  ROS_INFO_STREAM(" \033[1;36m"<<debug_total_num + map_complement.points.size()<<"\033[0m | "<<debug_total_num <<
    //  " + \033[1;34m"<<map_complement.points.size()<<"\033[0m");
}
...
void ERASOR::extract_ground(const pcl::PointCloud<pcl::PointXYZI> &src, pcl::PointCloud<pcl::PointXYZI> &dst,
